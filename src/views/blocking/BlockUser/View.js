...
export default function CustomizedTables() {
  ...
  const handleClickSearch = () => {
    ...
    api.get(`${Api.request.URL}/api/v2/Users/transactions/block/list?search=${search}&start=${0}`)
      .then(res => {
  ...
  const handleClickblockUnblock = (type) => {
    ...
    api
      ...
      .then(res => {
        ...
        newArena[sample].isAutoWithdraw = type === 'block' ? 1 : 0;
                ...
                return (
                  ...
                  <StyledTableRow key={i}>
                    ...
                    <StyledTableCell align="left"><Button
                      ...
                      onClick={e => handleClickblock(e, row.id, row.username, row.isAutoWithdraw)}
                    >{row.isAutoWithdraw === 1 ? 'Unblock' : 'Block'}
                    </Button >
                    </StyledTableCell>
        ...
        <DialogContent>
          <DialogContent>
            <DialogContentText id="alert-dialog-description">
              Are you sure you want to {autoWIthdraw === 1 ? 'unblock' : 'block'} {userName}?
          </DialogContentText>
          </DialogContent>
