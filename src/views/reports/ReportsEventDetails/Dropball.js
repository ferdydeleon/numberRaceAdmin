          ...
          const DADADA = [
            {
              red: res.data.data
                .reduce(
                  (a, v) =>
                    (a = a + parseFloat(v.total_bet_red.replaceAll(",", ""))),
                  0
                )
              ...
              blue: res.data.data
                .reduce(
                  (a, v) =>
                    (a = a + parseFloat(v.total_bet_blue.replaceAll(",", ""))),
                  0
                )
                .toLocaleString(undefined, {
                  minimumFractionDigits: 2,
              ...
              jackpot: res.data.data
                .reduce(
                  (a, v) =>
                    (a =
                      a + parseFloat(v.total_bet_jackpot.replaceAll(",", ""))),
                  0
                )
                .toLocaleString(undefined, {
                  minimumFractionDigits: 2,
              ...
              bet: res.data.data
                .reduce(
                  (a, v) =>
                    (a = a + parseFloat(v.total_bet.replaceAll(",", ""))),
                  0
                )
                .toLocaleString(undefined, {
                  minimumFractionDigits: 2,
              ...
              bankerLoss: res.data.data
                .reduce(
                  (a, v) =>
                    (a = a + (v.banker_loss === null ? 0 : v.banker_loss)),
                  0
                )
                .toLocaleString(undefined, {
                  minimumFractionDigits: 2,
              ...
              bankerIncome: res.data.data
                .reduce(
                  (a, v) =>
                    (a = a + (v.banker_income === null ? 0 : v.banker_income)),
                  0
                )
                .toLocaleString(undefined, {
                  minimumFractionDigits: 2,
              ...
              rollback: res.data.data
                .reduce(
                  (a, v) =>
                    (a =
                      a + (v.rollback_points === null ? 0 : v.rollback_points)),
                  0
                )
                .toLocaleString(undefined, {
                  minimumFractionDigits: 2,
              ...
              plasada: res.data.data
                .reduce(
                  (a, v) =>
                    (a =
                      a + typeof v.plasada === "string"
                        ? parseFloat(v.plasada.replaceAll(",", ""))
                        : v.plasada),
                  0
                )
                .toLocaleString(undefined, {
              ...
              agent: res.data.data
                .reduce(
                  (a, v) =>
                    (a =
                      a + typeof v.agent === "string"
                        ? parseFloat(v.agent.replaceAll(",", ""))
                        : v.agent),
                  0
                )
                .toLocaleString(undefined, {
              ...
              company: res.data.data
                .reduce(
                  (a, v) =>
                    (a =
                      a + typeof v.company === "string"
                        ? parseFloat(v.company.replaceAll(",", ""))
                        : v.company),
                  0
                )
                .toLocaleString(undefined, {
      ...
      >
        ...
        >
          <ExcelSheet data={posts} name={eventName}>
            ...
            <ExcelColumn label="Total Bet Jackpot" value="total_bet_jackpot" />
          ...
          <ExcelSheet data={totalBeT} name="Fight History Details Total">
            ...
            <ExcelColumn
              label="Total Bet Jackpot"
              value={(col) => col.jackpot}
            />
            <ExcelColumn label="Total Bet" value={(col) => col.bet} />
            <ExcelColumn
              label="Total Banker Loss"
              value={(col) => col.bankerLoss}
            />
            <ExcelColumn
              label="Total Banker Income"
              value={(col) => col.bankerIncome}
            />
            <ExcelColumn
              label="Total Rollback Points"
              value={(col) => col.rollback}
            />
          ...
          >
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="center">Total Jackpot</StyledTableCell>
            ...
            <TableBody>
              ...
              >
                {posts
                  .reduce(
                    (a, v) =>
                      (a =
                        a + parseFloat(v.total_bet_blue.replaceAll(",", ""))),
                    0
                  )
                  .toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                ...
                {posts
                  .reduce(
                    (a, v) =>
                      (a =
                        a +
                        parseFloat(v.total_bet_jackpot.replaceAll(",", ""))),
                    0
                  )
                  .toLocaleString(undefined, {
                    minimumFractionDigits: 2,
              ...
              >
                {posts
                  .reduce((a, v) => (a = a + v.banker_loss), 0)
                  .toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
              ...
              >
                {posts
                  .reduce((a, v) => (a = a + v.banker_income), 0)
                  .toLocaleString(undefined, {
                    minimumFractionDigits: 2,
                    maximumFractionDigits: 2,
                  })}
                ...
                {posts
                  .reduce(
                    (a, v) =>
                      (a =
                        a +
                        (v.rollback_points === null ? 0 : v.rollback_points)),
                    0
                  )
                  .toLocaleString(undefined, {
                    minimumFractionDigits: 2,
