    ...
    try {
      await api
        ...
        .then((res) => {
          ...
          const DADADA = [{
            left: (res.data.data.reduce((a, v) => a = a +   parseFloat(v.total_bet_left.replaceAll(',', '')), 0)).toLocaleString(undefined, {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2
            }),
            right: (res.data.data.reduce((a, v) => a = a +   parseFloat(v.total_bet_right.replaceAll(',', '')), 0)).toLocaleString(undefined, {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2
            }),
            ...
            plasada: (res.data.data.reduce((a, v) => a = a +   parseFloat(v.plasada.replaceAll(',', '')), 0)).toLocaleString(undefined, {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2
            }),
            agent: (res.data.data.reduce((a, v) => a = a +   parseFloat(v.agent.replaceAll(',', '')), 0)).toLocaleString(undefined, {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2
            }),
            company: (res.data.data.reduce((a, v) => a = a +   parseFloat(v.company.replaceAll(',', '')), 0)).toLocaleString(undefined, {
              minimumFractionDigits: 2,
              maximumFractionDigits: 2
            }),
          }]
      ...
      >
        ...
        >
          <ExcelSheet data={posts} name={eventName}>
            ...
            <ExcelColumn label="Total Bet Left" value="total_bet_left" />
            <ExcelColumn label="Total Bet Right" value="total_bet_right" />
          ...
          <ExcelColumn label="Total Bet Left" value={(col) => col.left} />
          <ExcelColumn label="Total Bet Right" value={(col) => col.right} />
        ...
        >
          <TableHead>
            <TableRow>
              ...
              <StyledTableCell align="center">Total Bet Left </StyledTableCell>
              <StyledTableCell align="center">Total Bet Right</StyledTableCell>
          ...
          <TableBody>
            {posts.length ? (
              ...
              <StyledTableRow>
                <StyledTableCell component="th" scope="row" key={1} colSpan={11}>
                  No records found!
                </StyledTableCell>
              </StyledTableRow>
            )}
            <StyledTableCell align="center" style={{ color: 'red', fontWeight: 600 }}>Total</StyledTableCell>
            <StyledTableCell align="center" style={{ color: 'red', fontWeight: 600 }}>{(posts.reduce((a, v) => a = a +   parseFloat(v.total_bet_left.replaceAll(',', '')), 0)).toLocaleString(undefined, {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          })}</StyledTableCell>
            <StyledTableCell align="center" style={{ color: 'red', fontWeight: 600 }}>{(posts.reduce((a, v) => a = a +   parseFloat(v.total_bet_right.replaceAll(',', '')), 0)).toLocaleString(undefined, {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          })}</StyledTableCell>
          ...
          <StyledTableCell align="center" style={{ color: 'red', fontWeight: 600 }}>{(posts.reduce((a, v) => a = a +   parseFloat(v.plasada.replaceAll(',', '')), 0)).toLocaleString(undefined, {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          })}</StyledTableCell>
          <StyledTableCell align="center" style={{ color: 'red', fontWeight: 600 }}>{(posts.reduce((a, v) => a = a +   parseFloat(v.agent.replaceAll(',', '')), 0)).toLocaleString(undefined, {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          })}</StyledTableCell>
          <StyledTableCell align="center" style={{ color: 'red', fontWeight: 600 }}>{(posts.reduce((a, v) => a = a +   parseFloat(v.company.replaceAll(',', '')), 0)).toLocaleString(undefined, {
            minimumFractionDigits: 2,
            maximumFractionDigits: 2
          })}</StyledTableCell>
